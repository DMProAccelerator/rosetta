...
HD_PWD='/home/belgau/Documents/DMPRO/rosetta/build/bitfile_synth/bitfile_synth.runs/procsys_auto_pc_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log procsys_auto_pc_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source procsys_auto_pc_3.tcl
