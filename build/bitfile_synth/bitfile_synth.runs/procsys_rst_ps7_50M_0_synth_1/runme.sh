...
HD_PWD='/home/belgau/Documents/DMPRO/rosetta/build/bitfile_synth/bitfile_synth.runs/procsys_rst_ps7_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log procsys_rst_ps7_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source procsys_rst_ps7_50M_0.tcl
