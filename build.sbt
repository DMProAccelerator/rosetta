...
lazy val rosetta_template = (project in file(".")).settings(rosettaSettings: _*).dependsOn(ProjectRef(uri("https://github.com/belgaux/fpga-tidbits.git#pynq-memport"), "fpgatidbits"))
